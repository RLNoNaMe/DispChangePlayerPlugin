...
* [4. プラグインのアップデート](#4-プラグインのアップデート)
* [5. プラグインのアンインストール](#5-プラグインのアンインストール)
* [6. よくある質問](#6-よくある質問)
* [7. コミュニケーション・お問い合わせ先](#7-コミュニケーションお問い合わせ先)
...
プラグインのアップデート情報は、  
[7. コミュニケーション・お問い合わせ先](#7-コミュニケーションお問い合わせ先)の**Twitter**、**Discord**のほうで通知しています。
...
### 6.3. カジュアル、ランクでもこのプラグインが動いているけどBANされない？
...
アップデート情報は下記の**Twitter**、**Discord**のほうで通知しています。
